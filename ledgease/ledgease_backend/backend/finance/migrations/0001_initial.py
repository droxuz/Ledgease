    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('EXPENSE', 'Expense'), ('SPENDING', 'Spending')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('INCOME', 'Income'), ('EXPENSE', 'Expense'), ('SPENDING', 'Spending')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spending_total', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
